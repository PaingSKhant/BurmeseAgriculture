...
<i class="fa-brands fa-pagelines  text-3xl ms-3"></i>
  ...
  <a href="index.php">
  <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
      Back
    </button>
  </a>
    ...
    <div class="flex flex-wrap mt-16">
      ...
      <?php foreach ($pageData as $plant) : ?>
        ...
        <?php if($plant['Id'] == $id) : ?>
                  ...
                  <img class=" rounded-xl mb-4 " src="<?php echo $imageFolder . $plant['Id'] . '.jpg'; ?>">
               
                    <div class="bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                      <div class="text-black mb-2 leading-tight">
                      <p class="mt-1 font-bold text-2xl">Author : <?php echo $plant['Author'] ?></p>

                      <p class="mt-4 font-bold text-2xl">By : <?php echo $plant['Title'] ?></p>
                        <h1 class="mt-4 text-xl"> <?php echo $plant['Content'] ?></h1>
